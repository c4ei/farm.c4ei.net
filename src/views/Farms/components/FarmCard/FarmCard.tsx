...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  // We assume the token name is coin pair + lp e.g. CAKE-C4EI LP, LINK-C4EI LP,
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'SAWON' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          ...
          bscScanAddress={
            farm.isTokenOnly ?
              `https://exp.c4ei.net/token/${farm.tokenAddresses[process.env.REACT_APP_CHAIN_ID]}`
              :
              `https://exp.c4ei.net/token/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`
          }
